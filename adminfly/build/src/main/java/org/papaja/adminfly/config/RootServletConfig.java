...
public class RootServletConfig implements WebMvcConfigurer {
    ...
    private static final Logger      LOGGER = Logger.getLogger(RootServletConfig.class.getName());
    protected            Environment environment;

    @Autowired
    public RootServletConfig(Environment environment) {
    ...
    public ThemeSource themeSource() {
        ...
        source.setDefaultEncoding(UTF8.displayName());
