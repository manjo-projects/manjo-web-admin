...
public enum FormulaData {
    MAP;

    private static final Map<Gender, Map<Scale, Value>> VALUES;

    static {
        Map<Scale, Value> F_VALUES = new EnumMap<>(Scale.class);
        Map<Scale, Value> M_VALUES = new EnumMap<>(Scale.class);

        VALUES = new EnumMap<>(Gender.class);
    ...
    public Map<Scale, Value> getValues(Gender sex) {
