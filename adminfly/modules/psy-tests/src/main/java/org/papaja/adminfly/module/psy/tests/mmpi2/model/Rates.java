...
public class Rates {
    ...
    public static final EnumMap<Scale, double[]> M_RATES = new EnumMap<Scale, double[]>(Scale.class) {{
        put(Scale.SCALE_1, new double[] {
                ...
                105D, 106D, 107D, 108D, 109D, 110D, 111
        });
        put(Scale.SCALE_2, new double[] {
